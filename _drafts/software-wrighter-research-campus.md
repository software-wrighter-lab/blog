...
<video src="{{ '/assets/videos/campus-walkers.mp4' | relative_url }}" class="gutter-img-left" autoplay muted loop playsinline preload="auto" aria-label="People walking the paths of the campus map"></video>
