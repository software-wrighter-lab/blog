...
<figure class="inline-left no-invert" style="max-width: 290px;">
<img src="{{ '/assets/images/posts/cnn-windows.webp' | relative_url }}" alt="A 2D image with one neighborhood lifted out into a grid of patches shaped out_y by out_x by C by kh by kw">
</figure>
...
<figure class="inline-right no-invert" style="max-width: 290px;">
<img src="{{ '/assets/images/posts/cnn-broadcasting.webp' | relative_url }}" alt="A single small kernel aligned against every patch in the stack and reused rather than copied">
</figure>
...
<figure class="inline-left no-invert" style="max-width: 290px;">
<img src="{{ '/assets/images/posts/cnn-reduce.webp' | relative_url }}" alt="A rank-5 patch stack collapsing in one pass to a rank-2 out_y by out_x result">
</figure>
...
<figure class="inline-right no-invert" style="max-width: 290px;">
<img src="{{ '/assets/images/posts/cnn-training.webp' | relative_url }}" alt="Gradients from overlapping windows flowing back and accumulating into one shared input cell">
</figure>
